        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1">
            {tags.map((tag) => (
              <button
                key={tag.name}
                className="group w-full flex items-center justify-between px-3 py-2.5 text-sm rounded-xl text-sidebar-foreground hover:bg-gradient-to-r hover:from-sidebar-accent/20 hover:to-sidebar-accent/5 hover:shadow-sm hover:scale-[1.01] transition-all duration-200 ease-out"
              >
        ...
        <div className="relative">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                className="w-full justify-start px-3 py-2.5 rounded-xl hover:bg-gradient-to-r hover:from-sidebar-accent/20 hover:to-sidebar-accent/5 hover:shadow-sm hover:scale-[1.01] transition-all duration-200 ease-out group"
              >
