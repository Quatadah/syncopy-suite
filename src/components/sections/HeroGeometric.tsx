...
export default function HeroGeometric({
  ...
  return (
    <div className="bg-background relative flex min-h-screen w-full items-center justify-center overflow-hidden dark:bg-black">
      <div className="from-blue-500/20 dark:from-blue-500/30 absolute inset-0 bg-gradient-to-br via-transparent to-cyan-500/20 blur-3xl dark:to-cyan-500/30" />
      <div className="absolute inset-0 overflow-hidden">
        ...
        <ElegantShape
          ...
          height={60}
          rotate={20}
          gradient="from-emerald-500/70 dark:from-emerald-400/90"
        ...
        <ElegantShape
          ...
          height={40}
          rotate={-25}
          gradient="from-teal-500/70 dark:from-teal-400/90"
      ...
      <div className="relative z-10 container mx-auto max-w-6xl px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center">
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="border-blue-400/30 bg-white/5 mb-8 inline-flex items-center gap-2 rounded-full border px-4 py-1.5 shadow-sm backdrop-blur-sm md:mb-12"
          >
          ...
          >
            <h1 className="mx-4 mb-6 text-4xl font-bold tracking-tight sm:text-6xl md:mb-8 md:text-8xl">
              ...
              <span
                className={cn(
                  'from-blue-400 via-cyan-400 bg-gradient-to-r to-emerald-400 bg-clip-text p-4 text-transparent',
                  'font-bold',
                )}
              >
                {title2}
          ...
          <motion.div
            ...
            animate="visible"
          >
            <p className="text-gray-300 mx-auto mb-10 max-w-xl px-4 text-base leading-relaxed sm:text-lg md:text-xl">
              A powerful, free clipboard manager that syncs across all your devices. 
              Never lose important content again with smart organization, search, and end-to-end encryption.
            </p>
          </motion.div>
          <motion.div
            custom={3}
